  ...
  return (
    <div>
      <div
        ...
        style={{ width: "60%", height: "110%", marginLeft: "20%" }}
      >
        <Slide>
      ...
      <div style={{ textAlign: "center", fontSize: "3rem" }}>
        ...
        <div style={{ fontSize: "1.5rem", margin: "5%" }}>
          ...
          venenatis ut. Nulla facilisi. Pellentesque fringilla ultricies
          sodales. Nunc sit amet diam ut purus rhoncus eleifend accumsan vitae
