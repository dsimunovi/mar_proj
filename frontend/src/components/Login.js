            ...
            <form onSubmit={userLogin}>
              ...
              <div className="form-outline mb-4">
                <input
                  ...
                  name="Username"
                  value={username}
                  onChange={(e) => promjenaImena(e.target.value)}
                />
                <label className="form-label" htmlFor="loginName" id="user">
                  Username
                </label>
              </div>
              ...
              <div className="form-outline mb-4">
                <input
                  ...
                  name="Password"
                  value={pass}
                  onChange={(e) => promjenaLozinke(e.target.value)}
                />
                <label className="form-label" htmlFor="loginPassword" id="pass">
                  Password
                </label>
              </div>
